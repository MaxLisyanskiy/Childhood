        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="144" title="Форма отзыва из модального окна"]'); ?>
            </div>
        </div> 
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDL4uU0lmZdV-Z_ycZEPiyJRP0Pvwgy18w"></script>
