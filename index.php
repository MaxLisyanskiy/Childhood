                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:tel:<?php the_field('tel1', 2); ?>">tel:<?php the_field('tel1', 2); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:tel:<?php the_field('tel2', 2); ?>">tel:<?php the_field('tel2', 2); ?></a>
                                    </div>
                                </div>
                            </div>
